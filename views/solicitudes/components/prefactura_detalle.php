...
if (!empty($solicitud) && is_array($solicitud)):
    ...
    //print_r($data);
    //echo "</pre>";
    $solicitud_valor = $solicitud['created_at'] ?? null;
    ...
    $fecha_formateada = $solicitud_dt->format('d-m-Y H:i');
    ...
    <ul class="list-group mb-4 bg-light-subtle">
        <li class="list-group-item">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cake-fill"
                ...
                Nacimiento:</strong> <?= htmlspecialchars($fecha_nacimiento ?? 'No disponible') ?><br>
