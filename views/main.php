...
$username = $controller->getAuthenticatedUser();
$procedimientos_dia = $controller->getProcedimientosPorDia();
$fechas_json = json_encode($procedimientos_dia['fechas']);
$procedimientos_dia_json = json_encode($procedimientos_dia['totales']);
$total_patients = $controller->totalPacientes();
$total_users = $controller->totalUsuarios();
$total_protocols = $controller->totalProtocolos();
$cirugias_recientes = $controller->getCirugiasRecientes();
$total_cirugias = $controller->getTotalCirugias();
$top_procedimientos = $controller->getTopProcedimientosDelMes();
...
$plantillas = $controller->getPlantillasRecientes();
$diagnosticos_frecuentes = $controller->getDiagnosticosFrecuentes();
$solicitudes_quirurgicas = $controller->getUltimasSolicitudes();
$doctores_top = $controller->getTopDoctores();
?>
<html lang="es">
<head>
    <meta charset="utf-8">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-xxxl-9 col-xl-8 col-12">
                        <div class="row">
                            <?php include __DIR__ . '/components/cards/dashboard_top.php'; ?>
...
<?php
$estadisticas_afiliacion = $controller->getEstadisticasPorAfiliacion();
...
$revision_estados = $controller->getEstadosRevisionProtocolos();
...
<script src="/public/assets/vendor_components/OwlCarousel2/dist/owl.carousel.js"></script>
...
<script src="/public/js/pages/dashboard3.js?v=<?php echo time(); ?>"></script>
<script>
