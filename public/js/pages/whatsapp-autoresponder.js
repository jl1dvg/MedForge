        ...
        const renderBranch = (container, data = {}) => {
            ...
            const updateExtraFields = () => {
                ...
                if (type === 'patient_exists') {
                    ...
                    sourceCol.innerHTML = '<label class="form-label-sm">Fuente de búsqueda</label><select class="form-select form-select-sm" data-field="condition.source"><option value="local">Base de datos local</option><option value="any">Cualquiera disponible</option></select>';
                ...
                if (data.condition) {
                    ...
                    if (sourceSelect) sourceSelect.value = data.condition.source || 'local';
                }
            };
