(function () {
    ...
    function renderExamenesFiles(panel, rows, totalRows) {
        ...
        var cards = rows.map(function (row, index) {
            ...
            var examTriggerAttrs = ' data-action="open-exam-nas"'
                + ' data-nas-list-url="' + escapeHtml(nasListUrl) + '"'
                + ' data-nas-page-url="' + escapeHtml(nasPageUrl) + '"';
            ...
            return '<div class="d-flex justify-content-between align-items-center' + wrapperClass + '">'
                ...
                + '<a href="#" class="d-inline-block m-0 fs-16 fw-500 hover-blue"' + examTriggerAttrs + '>' + escapeHtml(examen) + '</a>'
                + '<a href="#" class="d-block text-decoration-none"' + examTriggerAttrs + '>'
                ...
                + '</div>'
                + '<div class="dropdown">'
                + '<a href="#"' + examTriggerAttrs + '><i class="mdi mdi-download bg-light rounded p-5 me-5 text-dark" aria-hidden="true"></i></a>'
                + '<a data-bs-toggle="dropdown" href="#" aria-expanded="false"><i class="mdi mdi-dots-vertical"></i></a>'
                + '<div class="dropdown-menu dropdown-menu-end">'
                + detalleAction
                + '<a class="dropdown-item" href="#"' + examTriggerAttrs + '><i class="mdi mdi-download"></i> Abrir imágenes</a>'
                + '</div>'
                + '</div>'
                + '</div>'
                + '</div>';
