...
@php
    $initialPackages = is_array($initialPackages ?? null) ? $initialPackages : [];
    $packagesJson = e(json_encode($initialPackages, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
@endphp
...
@section('content')
    <div class="content-header">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <a href="/v2/codes" class="btn btn-outline-secondary btn-sm">← Volver a códigos</a>
    ...
    <section class="content"
             id="code-packages-root"
             data-initial-packages="{{ $packagesJson }}"
             data-list-endpoint="/v2/codes/api/packages"
             data-show-endpoint-template="/v2/codes/api/packages/{id}"
             data-save-endpoint="/v2/codes/api/packages"
             data-update-endpoint-template="/v2/codes/api/packages/{id}"
             data-delete-endpoint-template="/v2/codes/api/packages/{id}/delete"
             data-code-search-endpoint="/v2/codes/api/search"
            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="flex-grow-1 overflow-auto" id="package-list"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body d-flex flex-wrap gap-2 justify-content-between">
                        <div>
                            ...
                            <button class="btn btn-outline-secondary" id="package-reset-btn">Limpiar</button>
                        </div>
...
@push('styles')
    <link rel="stylesheet" href="/css/pages/code-packages.css">
@endpush
