...
<h1>Dashboard de Cirugías - Resumen KPI</h1>
<p class="meta">
    Generado: {{ $generatedAt }} | Total de cirugías analizadas: {{ number_format($totalAtenciones) }}
    @if($rangeLabel !== '')
        | Periodo: {{ $rangeLabel }}
    @endif
</p>
...
<div class="notice scope">
    {{ $scopeNotice !== '' ? $scopeNotice : 'Este reporte consolida actividad quirúrgica, trazabilidad de facturación y producción real en USD.' }}
</div>
