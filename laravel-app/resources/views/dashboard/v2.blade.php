...
@php
    ...
    $fechasJson = json_encode(array_values((array) ($procedimientosDia['fechas'] ?? [])), JSON_UNESCAPED_UNICODE);
    $procedimientosDiaJson = json_encode(array_values((array) ($procedimientosDia['totales'] ?? [])), JSON_UNESCAPED_UNICODE);
    $membretesJson = json_encode(array_values((array) ($topProcedimientos['membretes'] ?? [])), JSON_UNESCAPED_UNICODE);
    $procedimientosMembreteJson = json_encode(array_values((array) ($topProcedimientos['totales'] ?? [])), JSON_UNESCAPED_UNICODE);
            ...
            <div class="box mb-15">
                <div class="box-body">
                    ...
                    <p class="text-muted fs-12 mb-0 mt-10">
                        Mostrando datos del periodo: <strong>{{ $rangeLabel }}</strong>
                        <span class="ms-10 badge bg-light text-primary v2-source-badge">Fuente: LARAVEL V2</span>
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-6 col-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <span class="stat-chip">Conversión {{ number_format((float) ($solicitudesFunnel['totales']['conversion_agendada'] ?? 0), 1) }}%</span>
                        </div>
                        <div class="box-body">
