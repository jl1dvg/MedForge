                ...
                <div class="list-group list-group-flush">
                    @forelse ($templates as $template)
                        ...
                        <a class="list-group-item list-group-item-action{{ $isActive ? ' active' : '' }}"
                           href="/mail-templates/cobertura/{{ rawurlencode($key) }}">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="fw-semibold">{{ $template['name'] ?? $key }}</div>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    @else
                        <form method="post" action="/mail-templates/cobertura/{{ rawurlencode($selectedKey) }}"
                              data-template-form>
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="templateName" name="name"
                                           value="{{ $selectedTemplate['name'] ?? '' }}" required>
                                </div>
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="templateSubject" name="subject_template"
                                           ...
                                           value="{{ $selectedTemplate['subject_template'] ?? '' }}" required>
                                </div>
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="templateHtml" rows="6" name="body_template_html"
                                              data-template-html>{{ $selectedTemplate['body_template_html'] ?? '' }}</textarea>
                                </div>
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="templateText" rows="6" name="body_template_text"
                                              data-template-text>{{ $selectedTemplate['body_template_text'] ?? '' }}</textarea>
                                </div>
                                <div class="col-md-6">
