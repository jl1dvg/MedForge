...
export const TIPOS = [
  ...
  { key: 'AUTOFLUORESCENCIA',label: 'Autofluorescencia',            short: 'Autofluorescencia', icon: 'mdi-image-filter-hdr',           equipo: 'Heidelberg Spectralis' },
...
export const TEMPLATES = {
  ...
  AUTOFLUORESCENCIA: {
    titulo: 'Autofluorescencia',
    bilateral: true,
    campos: [
      { k: 'hallazgos', label: 'Descripción', type: 'text', ph: 'Patrón de autofluorescencia, hipo/hiperautofluorescencia…' },
    ],
    legacyMap: { hallazgos: 'input' },
    checksTextKey: 'hallazgos',
    checks: [
      { id: 'dln', label: 'DLN', text: 'Patrón de fluorescencia homogéneo y uniforme en todo el fondo de ojo, sin áreas de hiper o hipofluorescencia significativa. Mácula con autofluorescencia normal, epitelio pigmentario continuo, nervio óptico de bordes definidos y vasos sin alteraciones.' },
      { id: 'hiperautofluorescencia', label: 'Hiperautofluorescencia', text: 'AUMENTO ANORMAL DE LA AUTOFLOURESCENCIA' },
      { id: 'hipoautofluorescencia', label: 'Hipoautofluorescencia', text: 'DISMINUCIÓN ANORMAL DE LA AUTOFLOURESCENCIA' },
      { id: 'drusen', label: 'Drusen', text: 'DEPÓSITOS AMARILLOS EN LA RETINA' },
      { id: 'atrofia_geografica', label: 'Atrofia geográfica', text: 'Se observa un patrón irregular en la región macular con áreas de hipofluorescencia bien delimitadas, indicativas de atrofia geográfica del epitelio pigmentario de la retina.' },
      { id: 'placas_de_hiperautofluorescencia', label: 'Placas hiperAF', text: 'PLACAS O ÁREAS DE AUMENTO DE AUTOFLOURESCENCIA' },
      { id: 'retinitis_pigmentosa', label: 'Sal y pimienta', text: 'Patrón de sal y pimienta en la periferia, indicando variaciones en la acumulación de lipofuscina en el epitelio pigmentario de la retina.' },
      { id: 'enfermedad_de_best', label: 'Best', text: 'LESIONES AUTOFLOURESCENTES EN EL EPR' },
      { id: 'dmri', label: 'DMRI', text: 'DEGENERACIÓN MACULAR RELACIONADA CON LA EDAD' },
      { id: 'coloboma', label: 'Coloboma', text: 'DEFECTO CONGÉNITO EN EL OJO' },
      { id: 'distrofia_coroidal_central_serosa', label: 'CSC', text: 'ACUMULACIÓN DE LÍQUIDO SUBRETINIANO' },
    ],
  },
  ANGIOGRAFIA: {
