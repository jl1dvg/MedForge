...
export function WaApp() {
  ...
  // color-mix() requiere Chrome 111+; calculamos en JS para compatibilidad con browsers viejos.
  const blendWithWhite = useCallback((hex, pct) => {
    try {
      const r = parseInt(hex.slice(1, 3), 16), g = parseInt(hex.slice(3, 5), 16), b = parseInt(hex.slice(5, 7), 16);
      const t = pct / 100, mix = (c) => Math.round(c * t + 255 * (1 - t));
