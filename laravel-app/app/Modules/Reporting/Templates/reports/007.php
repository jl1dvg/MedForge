...
?>
    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="26" class="blanco"><?php if (!empty($solicitud['doctor_firma'])): ?>
                    <div style="margin-bottom: -25px;">
                        <img src="<?= htmlspecialchars((string)$solicitud['doctor_firma']) ?>" alt="Firma del cirujano"
                             style="max-height: 60px;">
                    </div>
                <?php endif; ?>
            </td>
            <td colspan="30" class="blanco"><?php if (!empty($solicitud['doctor_firma'])): ?>
                    <div style="margin-bottom: -25px;">
                        <img src="<?= htmlspecialchars((string)$solicitud['doctor_firma']) ?>" alt="Firma del cirujano"
                             style="max-height: 60px;">
                    </div>
