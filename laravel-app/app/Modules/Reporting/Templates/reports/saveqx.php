...
?>
    ...
    <table>
        ...
        <tr>
            <td class="blanco_unbordered" colspan="23" style="border-right: 1px solid #808080;"><b>El paciente ha
                    confirmado</b></td>
            <td class="blanco_unbordered" colspan="23" style="border-right: 1px solid #808080;"><b>Confirrmación que
                    todos
                    los miembros del equipo se han presentado
                    por su nombre y función</b>
            </td>
            <td class="blanco_unbordered" colspan="24"><b>El responsable de la lista de chequeo confirma<br>verbalmente
                    con
        ...
        <tr>
            ...
            <td class="blanco_unbordered" colspan="2"></td>
            <td class="blanco_unbordered" style="border-right: 1px solid #808080;"></td>
            <td class="blanco_unbordered" colspan="16" rowspan="2">El anestesiólogo expresa algún problema específico
            </td>
            <td class="blanco_unbordered"></td>
            <td class="blanco_unbordered" colspan="2">SI</td>
            <td class="blanco_unbordered"></td>
        ...
        <tr>
            ...
            <td class="blanco_unbordered" colspan="2"></td>
            <td class="blanco_unbordered" style="border-right: 1px solid #808080;"></td>
            <td class="blanco_unbordered" colspan="24" rowspan="2"><b>Etiquetado de las muestras (nombres y
                    apellidos<br>completos
                    del
        ...
        <tr>
            <td class="blanco_unbordered" colspan="23" style="border-right: 1px solid #808080;"></td>
            <td class="blanco_unbordered" colspan="16" rowspan="2">Dudas o problemas relacionados<br>con el instrumental
                y
                equipos.
            </td>
            <td class="blanco_unbordered"></td>
        ...
        <tr>
            ...
            <td class="blanco_unbordered" colspan="23" rowspan="2" style="border-right: 1px solid #808080;"><b>Dispone
                    de
        ...
        <tr>
            <td class="blanco_unbordered" colspan="23" style="border-right: 1px solid #808080;"></td>
            <td class="blanco_unbordered" colspan="23" style="border-right: 1px solid #808080;"></td>
            <td class="blanco_unbordered" colspan="24" rowspan="2"><b>Si hay problemas que resolver, relacionados
                    con<br>el
                    instrumental
                    y los equipos</b>
            </td>
        ...
        <tr>
            <td class="morado" colspan="46" style="border-top: 1px solid #808080; border-right: 1px solid #808080">F.
                DATOS
    ...
    <table style="border: none">
        <TR>
            ...
            <TD colspan="3" ALIGN=RIGHT VALIGN=TOP><B><FONT SIZE=3 COLOR="#000000">LISTA VERIFICACIÓN CIRUGÍA
                        SEGURA</FONT></B>
            </TD>
        </TR>
    </table>
