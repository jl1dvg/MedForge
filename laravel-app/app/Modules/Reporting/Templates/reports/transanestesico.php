...
?>
    ...
    <table class="trans">
        ...
        <tr style="height: 12px">
            ...
            <td class="s38" colspan="2">45</td>
            <td class="s38"></td>
            <td class="s40"><img src="https://cdn-icons-png.flaticon.com/512/626/626075.png" alt="Icon"
                                 style="height: 6px">
            </td>
        </tr>
        <tr style="height: 12px">
        ...
        <tr style="height: 15px">
            ...
            <td class="s38" colspan="2">45</td>
            <td class="s38"></td>
            <td class="s54"><img src="https://cdn-icons-png.flaticon.com/512/626/626075.png" alt="Icon"
                                 style="height: 6px">
            </td>
        </tr>
        <tr style="height: 12px">
