...
use App\Modules\Reporting\Services\Definitions\PdfTemplateDefinitionInterface;
use App\Modules\Reporting\Support\PdfDestinationNormalizer;
...
class PdfTemplateRenderer
{
    ...
    {
        $defaultPath = $this->appBasePath() . '/storage/reporting/templates';
    ...
    private function resolveTemplate(string $templatePath): string
    {
        ...
        if ($path[0] === '/' || str_starts_with($path, $this->appBasePath())) {
            return $path;
        }
