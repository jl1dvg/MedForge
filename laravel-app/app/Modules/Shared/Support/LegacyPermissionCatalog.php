...
class LegacyPermissionCatalog
{
    ...
    private const ALIAS_MAP = [
        ...
        'whatsapp.manage' => ['whatsapp.chat.view', 'whatsapp.chat.send', 'whatsapp.chat.assign', 'whatsapp.chat.supervise', 'whatsapp.templates.manage', 'whatsapp.autoresponder.manage', 'whatsapp.notifications.receive'],
        'whatsapp.chat.send' => ['whatsapp.chat.view'],
        'whatsapp.chat.assign' => ['whatsapp.chat.view'],
        'whatsapp.chat.supervise' => ['whatsapp.chat.view', 'whatsapp.chat.assign', 'whatsapp.notifications.receive'],
