...
class KpiDashboardService
{
    ...
    public function buildDashboard(
        ...
        $attributedAppointments = $this->attributedAppointmentSource()->attributedAppointments($from, $toExclusive, $roleId, $agentId);
        $appointmentTypes = $this->appointmentTypeBreakdown($attributedAppointments);
    ...
    private function attributedAppointmentSource(): WhatsappAttributedAppointmentSourceService
    {
        return app(WhatsappAttributedAppointmentSourceService::class);
    }
    ...
    {
        return $this->attributedAppointmentSource()->humanAttributionSummary(
            new DateTimeImmutable($fromSql),
            new DateTimeImmutable($toSql),
            $roleId,
            $agentId
        );
    }
