...
{
    public static function calcularTotalFactura(array $datosPaciente, BillingInformeDataService $billingController): float
    {
        $total = 0;
    ...
    public static function obtenerConsolidadoFiltrado(
        array             $facturas,
        array             $filtros,
        BillingInformeDataService $billingController,
        BillingInformePacienteService $pacienteService,
    ...
    public static function filtrarPacientes(
        array $pacientes,
        array &$pacientesCache,
        array &$datosCache,
        BillingInformePacienteService $pacienteService,
