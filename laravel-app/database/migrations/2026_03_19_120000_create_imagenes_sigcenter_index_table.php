...
return new class extends Migration
{
    ...
    {
        Schema::create('imagenes_sigcenter_index', function (Blueprint $table): void {
            $table->id();
            $table->string('form_id', 50)->unique();
            $table->string('hc_number', 50)->index();
            $table->string('pedido_cirugia_id', 50)->nullable()->index();
            $table->string('derivacion_pedido_id', 50)->nullable()->index();
            $table->string('doc_solicitud_id', 50)->nullable()->index();
            $table->boolean('has_files')->default(false)->index();
            $table->boolean('has_db_rows')->default(false)->index();
            ...
            $table->unsignedInteger('verified_files_count')->default(0);
            ...
            $table->json('candidate_doc_ids')->nullable();
    ...
    {
        Schema::dropIfExists('imagenes_sigcenter_index');
    }
};
