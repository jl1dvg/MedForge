...
/*        if(!is_dir(BACKUPS_FOLDER)){
        ...
        if($theme != 'application'){
            copy(APPPATH . 'views/themes/application/template_parts/contract_attachments.php',APPPATH . 'views/themes/' . active_clients_theme() . '/template_parts/contract_attachments.php');
        }
