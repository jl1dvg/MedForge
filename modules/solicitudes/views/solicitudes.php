...
<section class="content">
                ...
                <div class="row g-3 mt-1 align-items-end">
                    <div class="col-lg-5 col-md-12">
                        ...
                        <div class="d-flex flex-wrap gap-3 align-items-center">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="kanbanDerivacionVencidaFilter">Mostrar solo vencidas</label>
                            </div>
                            <div class="form-check d-flex align-items-center gap-2">
                                ...
                                <input type="number" min="0" step="1" value="7" class="form-control form-control-sm"
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="kanbanCrmSinResponsableFilter">Sin responsable asignado</label>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        window.__solicitudesChecklistStages = <?= json_encode($stagesConfig, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_SLASHES); ?>;
    </script>
