...
<section class="content">
    <style>
        ...
        .notification-panel.control-sidebar-open {
            right: 0;
        }
...
<aside id="kanbanNotificationPanel" class="control-sidebar notification-panel" aria-hidden="true">
    <div class="rpanel-title d-flex align-items-center justify-content-between px-3 py-2">
        <h5 class="mb-0">Centro de notificaciones</h5>
        <span class="pull-right btn btn-circle btn-danger" data-action="close-panel" aria-label="Cerrar panel" role="button" tabindex="0">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="control-sidebar-home-tab" role="tabpanel">
            <div class="flexbox notification-panel__toolbar align-items-center">
                <a href="javascript:void(0)" class="text-grey" aria-hidden="true">
                    <i class="ti-more"></i>
                </a>
                <p class="mb-0">Novedades en vivo</p>
                <a href="javascript:void(0)" class="text-end text-grey" aria-hidden="true">
                    <i class="ti-plus"></i>
                </a>
            </div>
