...
<div class="content-header">
    <div class="d-flex align-items-center">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            <button type="button" class="btn btn-outline-secondary" data-notification-panel-toggle="true">
                <i class="mdi mdi-bell-outline"></i> Notificaciones
            </button>
...
<section class="content">
    <style>
        ...
        .notification-panel__backdrop.is-visible {
            opacity: 1;
            visibility: visible;
        }
        ...
        .notification-panel__header h5 {
            font-weight: 600;
            margin: 0;
        }

        .notification-panel__channels {
        ...
        .notification-panel__tabs .nav-link {
            border: none;
            color: #64748b;
        ...
        .notification-panel__tabs .nav-link.active {
            color: #0f172a;
            font-weight: 600;
        }

        .notification-panel__tabs .nav-link .badge {
            font-size: 0.7rem;
        }

        .notification-panel .tab-content {
            flex: 1 1 auto;
            overflow-y: auto;
        ...
        .notification-panel__section-header span {
            font-size: 0.75rem;
            color: #94a3b8;
        }
        ...
        .notification-entry .media-body p {
        ...
        .notification-entry .avatar.bg-soft-success {
            background-color: rgba(34, 197, 94, 0.15);
            color: #15803d;
        }

        .notification-entry .avatar.bg-soft-info {
            background-color: rgba(14, 165, 233, 0.15);
            color: #0369a1;
        }

        .notification-entry .avatar.bg-soft-warning {
            background-color: rgba(251, 191, 36, 0.2);
            color: #92400e;
        }

        .notification-entry .avatar.bg-soft-danger {
            background-color: rgba(239, 68, 68, 0.15);
            color: #b91c1c;
        }

        .notification-entry .avatar.bg-soft-primary {
            background-color: rgba(59, 130, 246, 0.15);
            color: #1d4ed8;
        }

        .notification-entry .notification-meta {
            display: flex;
            flex-wrap: wrap;
            gap: 0.35rem;
            margin-top: 0.35rem;
        ...
        .notification-entry .notification-meta span {
            display: inline-flex;
            align-items: center;
            gap: 0.25rem;
        }
...
<aside id="kanbanNotificationPanel" class="notification-panel" aria-hidden="true">
    ...
    <ul class="nav nav-tabs notification-panel__tabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="notif-live-tab" data-bs-toggle="tab" data-bs-target="#notif-live" type="button" role="tab" aria-controls="notif-live" aria-selected="true">
                <i class="mdi mdi-message-text"></i>
                <span class="badge bg-primary rounded-pill" data-count="realtime">0</span>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="notif-pending-tab" data-bs-toggle="tab" data-bs-target="#notif-pending" type="button" role="tab" aria-controls="notif-pending" aria-selected="false">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="notif-live" role="tabpanel" aria-labelledby="notif-live-tab">
            <div class="notification-panel__section-header">
                <p class="mb-0">Eventos en tiempo real</p>
                <span>Actualizaciones generadas desde Pusher y CRM.</span>
            </div>
            <div class="media-list media-list-hover" data-panel-list="realtime">
                <p class="notification-empty">Aún no hay eventos recientes.</p>
            </div>
        </div>
        <div class="tab-pane fade" id="notif-pending" role="tabpanel" aria-labelledby="notif-pending-tab">
            <div class="notification-panel__section-header">
                <p class="mb-0">Recordatorios y pendientes</p>
                <span>Cirugías próximas y tareas críticas.</span>
            </div>
            <div class="media-list media-list-hover" data-panel-list="pending">
