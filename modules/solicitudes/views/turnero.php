...
<div class="content-header">
    <div class="d-flex align-items-center">
        <div class="me-auto">
            <h3 class="page-title">Turnero - Sala de espera</h3>
...
<section class="content">
    ...
    <div class="turnero-wrapper">
        <div class="turnero-header mb-4">
            <div>
                <h2 class="turnero-title mb-1">Pacientes en cola</h2>
                <p class="mb-0 text-info">Esta pantalla se actualiza automáticamente y muestra solo a los pacientes llamados o en atención.</p>
            </div>
        ...
        <div class="turnero-current" aria-live="assertive">
            <h3 class="turnero-subtitle mb-3">Turno en llamada</h3>
