...
final class KpiRegistry
{
    ...
    private const DEFINITIONS = [
        ...
        'cirugias.programacion.programadas' => [
            'label' => 'Cirugías programadas',
            'description' => 'Solicitudes con fecha programada en agenda quirúrgica.',
            'granularity' => ['daily'],
            'calculator' => 'cirugias_programacion',
            'value_type' => 'count',
        ],
        'cirugias.programacion.realizadas' => [
            'label' => 'Cirugías realizadas desde agenda',
            'description' => 'Solicitudes programadas que tienen protocolo de cirugía en el periodo.',
            'granularity' => ['daily'],
            'calculator' => 'cirugias_programacion',
            'value_type' => 'count',
        ],
        'cirugias.programacion.cumplimiento' => [
            'label' => 'Cumplimiento de programación quirúrgica',
            'description' => 'Porcentaje de cirugías realizadas sobre cirugías programadas.',
            'granularity' => ['daily'],
            'calculator' => 'cirugias_programacion',
            'value_type' => 'percentage',
        ],
        'cirugias.programacion.tasa_suspendidas' => [
            'label' => 'Tasa de cirugías suspendidas',
            'description' => 'Porcentaje de cirugías suspendidas/canceladas sobre programadas.',
            'granularity' => ['daily'],
            'calculator' => 'cirugias_programacion',
            'value_type' => 'percentage',
        ],
        'cirugias.programacion.tasa_reprogramacion' => [
            'label' => 'Tasa de reprogramación quirúrgica',
            'description' => 'Porcentaje de cirugías reprogramadas sobre programadas.',
            'granularity' => ['daily'],
            'calculator' => 'cirugias_programacion',
            'value_type' => 'percentage',
        ],
