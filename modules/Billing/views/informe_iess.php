...
$tableHeaderClass = trim((string)($grupoConfig['tableHeaderClass'] ?? 'bg-success-light'));
if ($tableHeaderClass === '') {
                                ...
                                <?php else: ?>
                                    ...
                                    foreach ($consolidadoAgrupado as $mes => $pacientesAgrupados):
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-2 flex-wrap gap-2">
                                            ...
                                            <?php if ($slug === 'consulta' && str_ends_with($basePath, '/informes/iess')): ?>
                                        ...
                                        <div class="table-responsive"
                                            ...
                                            >
                                                <thead class="<?= htmlspecialchars($tableHeaderClass) ?>">
                                                <tr>
