                            ...
                            <div class="chat-box-one-side3">
                                ...
                                <div class="media-list media-list-hover" style="max-height: 540px; overflow-y: auto;" data-conversation-list>
                                    <div class="media flex-column align-items-center py-5 text-center text-muted" data-empty-state>
                                        ...
                                        <p class="mb-0 small">Los mensajes recibidos aparecerán automáticamente en esta lista.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="chat-box-one-side3">
                                <form class="p-10" data-new-conversation-form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control form-control-sm" id="waMessage" name="message" rows="4" placeholder="Escribe el primer mensaje" required></textarea>
                                    </div>
                                    ...
                                    <?php if (!$isIntegrationEnabled): ?>
                                        <div class="alert alert-warning mt-3 mb-0" role="alert">
                                            Debes habilitar la integración de WhatsApp Cloud API para enviar mensajes manualmente.
                                        </div>
                                    <?php endif; ?>
                                </form>
                            </div>
                        ...
                        <div class="d-lg-flex d-block justify-content-between align-items-center w-p100">
                            ...
                            <div>
                                <ul class="list-inline mb-0 fs-18">
                                    <li class="list-inline-item"><span class="badge bg-primary-light text-primary d-none" data-unread-indicator></span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-body">
                    <div class="chat-box-one2" data-chat-messages style="max-height: 520px; overflow-y: auto;">
                        <div class="text-center text-muted py-5" data-chat-empty>
                            ...
                            <p class="mt-2 mb-1">Selecciona un contacto para ver el historial y continuar la conversación.</p>
                            <?php if (!$isIntegrationEnabled): ?>
                                <p class="mb-0 small">Aunque la integración no esté activa, puedes revisar los mensajes recibidos.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="d-md-flex d-block justify-content-between align-items-center bg-white p-5 rounded10 b-1 overflow-hidden" data-message-form>
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                            <div class="form-check me-2 mb-0">
                                ...
                                <label class="form-check-label" for="chatPreview">Vista previa enlaces</label>
                            </div>
                            <button type="submit" class="waves-effect waves-circle btn btn-circle btn-primary" <?= $isIntegrationEnabled ? '' : 'disabled'; ?>>
                ...
                <div class="box-body pt-0">
                    ...
                    <?php if (!$isIntegrationEnabled): ?>
                        <div class="alert alert-warning" role="alert">
                            Configura tu cuenta en <a href="/settings?section=whatsapp" class="alert-link">Ajustes &rarr; WhatsApp</a> para habilitar el envío manual.
                        </div>
                    <?php endif; ?>
                </div>
